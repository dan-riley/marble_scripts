...
def get_messages_filled_with_data():
    ...
    array_msg.artifacts[0].position.x = 71
    array_msg.artifacts[0].position.y = -61
    array_msg.artifacts[0].position.z = 0.3
    ...
    # array_msg.artifacts[1].position.x = 24
    # array_msg.artifacts[1].position.y = 2.6
    # array_msg.artifacts[1].position.z = 0.1
    # array_msg.artifacts[1].obj_class = 'drill'
    # array_msg.artifacts[1].obj_prob = 0.454
    #
    array_msg.artifacts[2].position.x = 61.0
    array_msg.artifacts[2].position.y = -1
    array_msg.artifacts[2].position.z = 0.3
    array_msg.artifacts[2].obj_class = 'person'
    array_msg.artifacts[2].obj_prob = 0.154
    array_msg.artifacts[2].has_been_reported = False

    array_msg.artifacts[3].position.x = 41
    array_msg.artifacts[3].position.y = 21
    array_msg.artifacts[3].position.z = 0.1
    array_msg.artifacts[3].obj_class = 'extinguisher'
    array_msg.artifacts[3].obj_prob = 0.972

    array_msg.artifacts[4].position.x = 64
    array_msg.artifacts[4].position.y = -41
    array_msg.artifacts[4].position.z = 0.3
    array_msg.artifacts[4].obj_class = 'extinguisher'
    array_msg.artifacts[4].obj_prob = 0.972

    # array_msg.artifacts[5].position.x = 14
    # array_msg.artifacts[5].position.y = -61
