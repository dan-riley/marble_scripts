...
class CommandPostRelay(object):
    def __init__(self):
        ...
        for i, robot_name in enumerate(self.robot_names, start=0):
            ...
            self.poses[u'poses'][i][u'name'] = robot_name.decode('utf-8')
    ...
    def handle_pose(self, msg, args):
        ...
        # Send message
        for pose in self.poses[u'poses']:
            orien = pose[u'orientation']
            if orien[u'x'] == 0 and orien[u'y'] == 0 and orien[u'z'] == 0 and orien[u'w'] == 0:
                orien[u'w'] = 1.0
